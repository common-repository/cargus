...
class Cargus_Public {
	 ...
	 * @since 1.0.0
	 */
	public static function cargus_display_map_button() {
		if ( is_cart() || is_checkout() ) {
            $content = '<tr class="cargus-ship-and-go-select d-none">
            ...
            echo wp_kses_post( apply_filters( 'cargus_ship_and_go_map_button', $content ) );
		}
	}
